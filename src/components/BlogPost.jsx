    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
        <article className="max-w-4xl mx-auto px-6 pt-24 md:pt-32 pb-20">
          ...
          <button
            onClick={() => navigate('/blog')}
            className="flex items-center gap-2 text-gray-400 hover:text-yellow-400 transition-all mb-10 group glass px-4 py-2 rounded-lg hover:scale-105"
          >
            <svg
          ...
          <header className="mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent">
              {metadata.title || 'Untitled Post'}
            </h1>

            {/* Meta Info */}
            <div className="flex flex-wrap items-center gap-4 text-sm md:text-base text-gray-400 pb-8 border-b-2 border-gradient-to-r from-transparent via-gray-700 to-transparent">
              {metadata.date && (
              ...
              {metadata.date && metadata.readTime && <span className="text-gray-600">•</span>}
              {metadata.readTime && (
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
